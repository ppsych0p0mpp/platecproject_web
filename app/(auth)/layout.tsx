  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-br from-[var(--primary)]/5 to-[var(--primary)]/5 rounded-full blur-3xl" />
